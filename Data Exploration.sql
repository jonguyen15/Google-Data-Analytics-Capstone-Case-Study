...
-- Code Chunk to find how many millennials and Gen X are subscribers and customers
SELECT birthyear
FROM `deft-processor-434616-r6.Divvy_Trips_2019_Q1.Divvy_2019`
WHERE birthyear >=1965 AND birthyear <= 1996 AND usertype = "Subscriber"

SELECT birthyear
FROM `deft-processor-434616-r6.Divvy_Trips_2019_Q1.Divvy_2019`
WHERE birthyear >=1965 AND birthyear <= 1996  AND usertype = "Customer"
